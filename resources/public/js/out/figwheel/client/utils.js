...
var or__28051__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj31137 = {"detail":data};
return obj31137;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28039__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28039__auto__)){
var and__28039__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__31144 = cljs.core._EQ_;
var expr__31145 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31144.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31145))){
return ((function (pred__31144,expr__31145){
return (function (p1__31138_SHARP_){
return console.warn(p1__31138_SHARP_);
});
;})(pred__31144,expr__31145))
} else {
if(cljs.core.truth_(pred__31144.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31145))){
return ((function (pred__31144,expr__31145){
return (function (p1__31139_SHARP_){
return console.debug(p1__31139_SHARP_);
});
;})(pred__31144,expr__31145))
} else {
if(cljs.core.truth_(pred__31144.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31145))){
return ((function (pred__31144,expr__31145){
return (function (p1__31140_SHARP_){
return console.error(p1__31140_SHARP_);
});
;})(pred__31144,expr__31145))
} else {
return ((function (pred__31144,expr__31145){
return (function (p1__31141_SHARP_){
return console.log(p1__31141_SHARP_);
});
;})(pred__31144,expr__31145))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31148){
var map__31149 = p__31148;
var map__31149__$1 = ((((!((map__31149 == null)))?((((map__31149.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31149.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31149):map__31149);
var opts = map__31149__$1;
var eval_fn = cljs.core.get.call(null,map__31149__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31151_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31153,(0),null);
var v = cljs.core.nth.call(null,vec__31153,(1),null);
...
if(cljs.core.truth_((function (){var and__28039__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1511221093905
